...
void draw_background(ui_t *ui)
{
    ...
    SDL_Rect layer1_draw = {-3200 + ((int)round(ui->tick * 0.02)) % 6400 + (int)round(mouseX * parallX),  (int)round(mouseY * parallY),   3200,   900};
    SDL_Rect layer2_draw = {-3200 + ((int)round(ui->tick * 0.05)) % 6400 + (int)round(mouseX * parallX),  (int)round(mouseY * parallY),   3200,   900};
    SDL_Rect layer3_draw = {-3200 + ((int)round(ui->tick * 0.15)) % 6400 + (int)round(mouseX * parallX),  (int)round(mouseY * parallY),   3200,   900};
  
    SDL_Rect layer1_draw2 = {-6400+ ((int)round(ui->tick * 0.02)) % 7600 + (int)round(mouseX * parallX),  (int)round(mouseY * parallY),   3200,   900};
    SDL_Rect layer2_draw2 = {-6400+ ((int)round(ui->tick * 0.05)) % 7600 + (int)round(mouseX * parallX),  (int)round(mouseY * parallY),   3200,   900};
    SDL_Rect layer3_draw2 = {-6400+ ((int)round(ui->tick * 0.15)) % 7600 + (int)round(mouseX * parallX),  (int)round(mouseY * parallY),   3200,   900};
